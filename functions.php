...
function scripts_theme() {
	...
	enqueue_theme_versioned_script( 'theme-swiper-script', '/dist/js/swiper.js' );
	enqueue_theme_versioned_script( 'wp_custom_main_script', '/dist/js/main.js', array( 'jquery', 'theme-swiper-script' ) );
