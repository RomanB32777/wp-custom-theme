...
<div class="fixed-button fixed bottom-0 z-10 w-full duration-200 invisible opacity-0" id="fixed-button">
	<div class="relative mx-auto max-w-7xl py-3 px-4 sm:px-6 lg:px-8">
		<div class="flex flex-col gap-y-3 justify-between md:!flex-row md:items-center">
							...
							if ( function_exists( 'custom_star_rating' ) ) {
								custom_star_rating(
									array(
										...
										'wrapper_classes' => 'gap-x-1 md:!gap-x-2',
										'star_classes'    => 'w-4 h-4 md:!w-5 md:!h-5',
									)
								);
							} 
							?>
	
							<span class="text-base text-white font-medium md:!text-lg">
	...
	<?php if ( $organization_bonus_value ) { ?>
		<div class="fixed-bonus relative h-full lg:!absolute lg:top-0 lg:left-[40%]">
			<div class="background-bonus absolute inset-0 lg:-skew-x-[30deg]"></div>

			<div class="relative h-full flex justify-center items-center gap-2 text-white font-bold uppercase text-base py-2 px-4 md:!text-xl lg:!px-10 lg:!py-0">
