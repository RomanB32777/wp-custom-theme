	...
	<div class="author-info">
		...
		<div class="rounded-lg flex flex-col gap-4 md:!py-6 lg:!flex-row lg:!gap-16">
			<div class="flex gap-2 flex-col md:!flex-row md:!gap-10">
				...
				<div>
					<a class="title-link duration-200 hover:text-secondary underline" href="<?php echo esc_url( $author_posts_url ); ?>" title="<?php echo esc_attr( $author_name ); ?>" rel="author">
