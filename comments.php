	...
	<div class="relative my-4 md:!mb-8">
		<?php
			$comment_field = '
				<div class="col-span-full">
					<textarea
						class="block resize-none w-full border main-border p-6 text-sm placeholder:text-grizzly text-dark"
			...
			$author_field = '
				<div class="comment-form-author col-span-3 col-start-1">
					<input
						class="block w-full border main-border p-6 text-sm placeholder:text-grizzly text-dark"
		...
		for ( $i = 1; $i <= 5; $i++ ) {
			...
			$comments_args = array(
				...
				'submit_button'        => '<input name="%1$s" type="submit" id="%2$s" class="main-button comment-submit relative text-base font-semibold w-full py-5 cursor-pointer disabled:opacity-75 %3$s" value="%4$s" />',
				'title_reply_before'   => '<h5 id="reply-title" class="comment-reply-title block-title mt-3 mb-6 font-semibold md:text-2xl">',
