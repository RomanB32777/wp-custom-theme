...
/*  Apps - Custom Title Start */

add_action( 'admin_init', 'app_custom_title_field' );

function app_custom_title_field() {
	$post_type  = 'app';
...
function app_custom_title_display_meta_box( $post ) {
...
add_action( 'save_post', 'app_custom_title_save_field', 10, 2 );

function app_custom_title_save_field( $post_id ) {
	custom_save_post_type_field( 'app', 'custom_title', $post_id );
}

/*  Apps - Custom Title End */
...
/*  Apps - Shortcode Content Start */

add_action( 'admin_init', 'app_shortcode_content_field' );

function app_shortcode_content_field() {
	$post_type  = 'app';
...
function app_shortcode_content_display_meta_box( $post ) {
	custom_text_field_display_meta_box(
		'shortcode_content',
		$post,
		array(
...
add_action( 'save_post', 'app_shortcode_content_save_field', 10, 2 );

function app_shortcode_content_save_field( $post_id ) {
	custom_save_post_type_field( 'app', 'shortcode_content', $post_id );
}

/*  Apps - Shortcode Content End */
...
function custom_app_background_image_block_save( $post_id ) {
	custom_save_post_type_field( 'app', 'background_image', $post_id );
}
