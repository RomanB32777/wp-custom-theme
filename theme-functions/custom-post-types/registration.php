...
/*  Registration - Custom Title Start */

add_action( 'admin_init', 'registration_custom_title_field' );

function registration_custom_title_field() {
...
function registration_custom_title_display_meta_box( $post ) {
...
add_action( 'save_post', 'registration_custom_title_save_field', 10, 2 );

function registration_custom_title_save_field( $post_id ) {
	custom_save_post_type_field( 'registration', 'custom_title', $post_id );
}

/*  Registration - Custom Title End */
...
/*  Registration - Bonus Currency Value Start */

add_action( 'admin_init', 'registration_bonus_currency_value_field' );

function registration_bonus_currency_value_field() {
	$post_type  = 'registration';
...
function registration_bonus_currency_value_display_meta_box( $post ) {
	custom_text_field_display_meta_box(
...
add_action( 'save_post', 'registration_bonus_currency_value_save_field', 10, 2 );

function registration_bonus_currency_value_save_field( $post_id ) {
	custom_save_post_type_field( 'registration', 'bonus_currency_value', $post_id );
}

/*  Registration - Bonus Currency Value End */
