...
add_action( 'admin_init', 'organization_shortcode_content_field' );

function organization_shortcode_content_field() {
	$post_type  = 'organization';
...
function organization_shortcode_content_display_meta_box( $post ) {
	custom_text_field_display_meta_box(
		'shortcode_content',
		$post,
		array(
