...
/*  Promotional Codes - Custom Title Start */

add_action( 'admin_init', 'promo_custom_title_field' );

function promo_custom_title_field() {
	$post_type  = 'promo';
...
function promo_custom_title_display_meta_box( $post ) {
...
add_action( 'save_post', 'promo_custom_title_save_field', 10, 2 );

function promo_custom_title_save_field( $post_id ) {
	custom_save_post_type_field( 'promo', 'custom_title', $post_id );
}

/*  Promotional Codes - Custom Title End */
...
/*  Promotional Codes - Bonus Currency Value Start */

add_action( 'admin_init', 'promo_bonus_currency_value_field' );

function promo_bonus_currency_value_field() {
	$post_type  = 'promo';
...
function promo_bonus_currency_value_display_meta_box( $post ) {
	custom_text_field_display_meta_box(
...
add_action( 'save_post', 'promo_bonus_currency_value_save_field', 10, 2 );

function promo_bonus_currency_value_save_field( $post_id ) {
	custom_save_post_type_field( 'promo', 'bonus_currency_value', $post_id );
}

/*  Promotional Codes - Bonus Currency Value End */
...
/*  Promotional Codes - Shortcode Content Start */

add_action( 'admin_init', 'promo_shortcode_content_field' );

function promo_shortcode_content_field() {
	$post_type  = 'promo';
...
function promo_shortcode_content_display_meta_box( $post ) {
	custom_text_field_display_meta_box(
		'shortcode_content',
		$post,
		array(
...
add_action( 'save_post', 'promo_shortcode_content_save_field', 10, 2 );

function promo_shortcode_content_save_field( $post_id ) {
	custom_save_post_type_field( 'promo', 'shortcode_content', $post_id );
}

/*  Promotional Codes - Shortcode Content End */
